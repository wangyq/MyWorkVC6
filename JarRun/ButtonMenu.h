...
//ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ
	BOOL SubclassWindow(HWND hWnd)
	{
		...
		{
			BOOL bRet = FALSE;
			m_Parent.SubclassWindow(::GetParent(hWnd));    //here is the same parent, then maybe subclass multi-times.!
...
//ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ
	...
	LRESULT OnDrawItem(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		TCHAR szText[128] = _T("");
		::GetWindowText(m_hWnd,szText,100);
		...
		else
		{
			...
			//::DrawTextW(DC,bstrCaption,lstrlenW(bstrCaption),rectText,DT_SINGLELINE|DT_CENTER|DT_VCENTER);
			::DrawText(DC,szText,lstrlenW(bstrCaption),rectText,DT_SINGLELINE|DT_CENTER|DT_VCENTER);
		}
